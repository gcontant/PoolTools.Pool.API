...
namespace Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20220917020549_AddPoolOptions")]
    partial class AddPoolOptions
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PoolTools.Pool.API.Domain.Entities.PoolOptions", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("RequiredDefencemen")
                        .HasColumnType("int");

                    b.Property<int>("RequiredForwards")
                        .HasColumnType("int");

                    b.Property<int>("RequiredGoaltenders")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PoolTools.Pool.API.Domain.Entities.PoolOptions", b =>
                {
                    b.HasOne("PoolTools.Pool.API.Domain.Entities.Pool", "Pool")
                        .WithOne("Options")
                        .HasForeignKey("PoolTools.Pool.API.Domain.Entities.PoolOptions", "PoolId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("PoolOptions_Pool_FK1");
